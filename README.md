# ClaudeU Labs organization files
...
- `profile/README.md`: public organization profile and repository navigation
- `CONTRIBUTING.md`: contribution scope and review expectations
- `SECURITY.md`: private vulnerability-reporting guidance
- `SUPPORT.md`: open-source versus commercial-product support routing
